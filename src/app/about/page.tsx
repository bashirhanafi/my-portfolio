...
export default function About() {
  const structure = [
    ...
    },
    {
      ...
      items: about.achievements.achivements.map((achievement) => achievement),
    },
  ];
  return (
    <Column maxWidth="m">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
              ...
              <Column fillWidth gap="l" marginBottom="40">
                {about.studies.institutions.map((institution, index) => (
                  <Column key={`${institution.name}-${index}`} fillWidth gap="4">
                    ...
                    <Column as="ul" gap="2">
                    {institution.achivements.map((achievement: JSX.Element, index: number) => (
                      <Text
                        as="li"
                        variant="body-default-m"
          ...
          {about.achievements.display && (
            <>
              ...
              <Column fillWidth gap="m" marginBottom="20">
                {about.achievements.achivements.map((achievement, index) => (
